	...
	@FindBy(how=How.XPATH,using="//*[@id=\"app\"]/div/div[2]/div/div[2]/div/div[2]/div[2]/div/div[1]/a[3]")
	@CacheLookup
	WebElement tendertoreview;
	public void TenderToreview() {
		wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[@id=\"app\"]/div/div[2]/div/div[2]/div/div[2]/div[2]/div/div[1]/a[3]")));
		tendertoreview.click();
	} 
	//-------------------------------------------------------------------------------------------------------
	@FindBy(how=How.XPATH,using="//*[@id=\"app\"]/div/div[2]/div/div[2]/div/div[2]/div[2]/div/div[2]/div/div[1]/table/tbody/tr[1]/td[2]/span")
	@CacheLookup 
	WebElement toreview; 
	public void toreview_tender() throws Exception {
		wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[@id=\"app\"]/div/div[2]/div/div[2]/div/div[2]/div[2]/div/div[2]/div/div[1]/table/tbody/tr[1]/td[2]/span")));
	...
	public void Price_unit() throws Exception {
		wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[@id=\"app\"]/div/div[2]/div/div[2]/div/div[2]/div[2]/div/div[2]/div/div/div[2]/div[3]/div[3]/div[2]/div[1]/div[1]/div[1]/div/input")));
		Assert.assertTrue(priceperunit.isDisplayed());
		Thread.sleep(1000); priceperunit.sendKeys("1.00");
	}
	
	@FindBy(how=How.XPATH,using="//*[@id=\"app\"]/div/div[2]/div/div[2]/div/div[2]/div[2]/div/div[2]/div/div/div[2]/div[3]/div[3]/div[2]/div[1]/div[2]/div[1]/textarea")
	@CacheLookup
	WebElement commentBuyerpriceperunit;
	public void comments_to_buyer_perunit() {
		wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[@id=\"app\"]/div/div[2]/div/div[2]/div/div[2]/div[2]/div/div[2]/div/div/div[2]/div[3]/div[3]/div[2]/div[1]/div[2]/div[1]/textarea")));
	...
	//-------------------------------------------------------------------------------------------
	@FindBy(how=How.XPATH,using="//*[@id=\"app\"]/div/div[2]/div/div[2]/div/div[2]/div[2]/div/div[2]/div/div/div[2]/div[7]/div[1]/div[1]/div/div/input")
	@CacheLookup
	WebElement warehousingcost;
	public void warehousing_cost() {
		wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[@id=\"app\"]/div/div[2]/div/div[2]/div/div[2]/div[2]/div/div[2]/div/div/div[2]/div[7]/div[1]/div[1]/div/div/input")));
		Assert.assertTrue(warehousingcost.isDisplayed());
		warehousingcost.sendKeys("2.00");
	}
	
	@FindBy(how=How.XPATH,using="//*[@id=\"app\"]/div/div[2]/div/div[2]/div/div[2]/div[2]/div/div[2]/div/div/div[2]/div[7]/div[1]/div[2]/div[1]/textarea")
	@CacheLookup
	WebElement commentBuyerwarehousingcost;
	public void comments_to_buyer_warehousing() {
		wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[@id=\"app\"]/div/div[2]/div/div[2]/div/div[2]/div[2]/div/div[2]/div/div/div[2]/div[7]/div[1]/div[2]/div[1]/textarea")));

...
=======
	...
	public CreateProvideRecipeBuyerPage(WebDriver driver) {
		...
		WebElement shortlistandprovidenotes;
		public void Shortlistandprovidenotes() {
			wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[@id=\"app\"]/div/div/div[2]/div/div[2]/div/div[2]/div/div/div[1]/div/div/div[3]/div/div/div[5]/div/button[2]")));
			shortlistandprovidenotes.click();
		}
		//-----------------------------------------------------------------------------------------------------------------------
		...
		WebElement submittosupplierforreview;
		public void SendToSupplier() {
			wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[@id=\"app\"]/div/div/div[2]/div/div[2]/div/div[2]/div/div/div[1]/div/div/div[3]/div/div/div[3]/button")));
			submittosupplierforreview.click();
		}
		//---------------------------------------------------------------------------------------------------------------------------
>>>>>>> a67b8f5397566c18f219b324a8e7421038d20ce1

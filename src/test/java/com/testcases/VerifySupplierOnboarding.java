...
public class VerifySupplierOnboarding {
	...
	public void createSupplier() throws Exception {
		...
		Thread.sleep(2000);
		supp.packagingCapacity();
		Thread.sleep(2000);
		supp.iAmBrewer();
		Thread.sleep(2000);
		supp.countryNewZeland();
		...
		supp.termsConditions();
		supp.continueAccount();
		// -----------------------------------------------Step
		// 2---------------------------------------------//
		supp.continu();
		supp.CompanyAddress();
		...
		// ---------------------------------------------------------Step
		// 10--------------------------------------------------//
		supp.profilePictureBuyer();
		supp.doneLogoSupplier();
		Thread.sleep(2000);
		supp.fileUploadOne();

		supp.finishSupplierOnboarding();
